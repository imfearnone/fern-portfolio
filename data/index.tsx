...
import jhsereno from "@/public/jhsereno.png";
...
export const words = [
  ...
  export const projectlists = [
    {
      title: "Julie Hansen Partnership - Services (Revamp)",
      image: jhsereno,
      description: "The Julie Hansen Partnership is a trusted real estate platform specializing in buying and selling properties",
      technologies: ["Next.js", "Vercel", "TypeScript", "Tailwind CSS"],
      github: "https://github.com/imfearnone/jhsereno",
      demo: "https://jhsereno.vercel.app/",
    },
    {
      title: "vMEME",
      image: vMEME,
      description: "vMeme is an e-commerce platform that showcases and sells unique paintings from local artists. It offers a user-friendly experience for art enthusiasts to explore and purchase one-of-a-kind artworks, supporting local talent and fostering a vibrant community of creativity.",
      technologies: ["Next.js", "React", "Vercel", "Node.js", "TypeScript", "Tailwind CSS", "Firebase", "MongoDB"],
    ...
    },
    {
      ...
      image: CC,
      description: "Community Crave is an e-commerce website that highlights local shops in West Rembo, Taguig City. It provides a platform for users to explore and support neighborhood businesses, offering a convenient way to shop locally and discover unique products.",
      technologies: ["Next.js", "React", "Vercel", "Node.js", "TypeScript", "Tailwind CSS", "Firebase", "MongoDB"],
    ...
    },
    {
      ...
      description: "Barangay Comembo Mobile Application is an innovative app for residents of Comembo, Taguig City, enabling them to conveniently request various documents without visiting the barangay office. Users can submit requests, receive notifications when their documents are ready for pickup, and track their requests within the app. Additionally, the application provides updates on local barangay activities. This user-friendly mobile app enhances accessibility and streamlines document requests for the community.",
      technologies: ["Android Studio", "Java", "Kotlin", "Android SDK", "Gradle", "Firebase"],
    },
    {
      title: "Mangadeck (Android)",
      image: mangadeck,
      description: "Mangadeck is a dedicated app for otaku to read their favorite manga and manhwa. The application features a user-friendly interface with frontend components designed for an enjoyable reading experience.",
      technologies: ["Android Studio", "Java", "Kotlin", "Android SDK", "Gradle", "Firebase"],
    },
    {
      title: "6.14 FoodHub",
      image: foodhub,
      description: "6.14 FoodHub is an e-commerce platform for a local shop in Pinagsama Phase 2, Taguig, showcasing its diverse range of products. The website provides a seamless shopping experience for customers, allowing them to browse and purchase local goods with ease.",
      technologies: ["HTML", "PHP", "JavaScript", "Bootstrap", "MySQL"],
    },
    {
      title: "e-Tech Workplace",
      image: eTech,
      description: "e-Tech Workplace is an e-commerce website dedicated to showcasing a wide range of electronic devices, including motherboards, cases, keyboards, headsets, and CPUs. The platform provides an easy-to-navigate shopping experience for tech enthusiasts looking to purchase the latest electronic products.",
